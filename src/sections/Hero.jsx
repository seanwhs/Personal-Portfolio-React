          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200 leading-relaxed">
                Hi, I'm Sean Wong. I bring decades of enterprise architecture
                experience to modern full-stack development. I specialize in
                building robust, fault-tolerant web applications, consulting on
                system security, and training engineering teams.
              </p>
            </div>
                ...
                <div className="absolute -bottom-4 -right-4 glass rounded-xl px-4 py-3 animate-float">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium">
                      Available for Projects & Strategy
                    </span>
                  </div>
                </div>
                {/* Stats Badge */}
